package com.kyo.ddl.presenter.test;
 ...
 */
public class TestPresenter<V> extends KyoBasePresenter{

    private V testView;
    private TestModel testModel=new TestModel();
    private final static int REQ_LOGIN=0;
    public TestPresenter(V testView){
    ...
    public class CustomHttpListener<P,V> implements HttpListener{
        ...
        public void onSucceed(int what, Response response) {
            ...
            ((TestView)weakView.get()).showResult(response);
        }
