...
//        if (mWaitDialog != null  && !mWaitDialog.isShowing() && what==0)
//            mWaitDialog.show();
    ...
    public void onSucceed(int what, Response<T> response) {
        ...
        if (responseCode > 400 && mContext != null) {
            if (responseCode == 405) {// 405表示服务器不支持这种请求方法，比如GET、POST、TRACE中的TRACE就很少有服务器支持。
                LogUtil.e(TAG, mContext.getResources().getString(R.string.request_succeed) + "" + mContext.getResources().getString(R.string.request_method_not_allow));
